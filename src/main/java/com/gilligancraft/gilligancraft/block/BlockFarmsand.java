...
public class BlockFarmsand extends Block {
	@SideOnly(Side.CLIENT)
	private IIcon field_149824_a;
	@SideOnly(Side.CLIENT)
	private IIcon field_149823_b;

	protected BlockFarmsand() {
		super(Material.sand);
		// Values set to match vanilla farmland
		setHardness(0.6F);
	...
	public AxisAlignedBB getCollisionBoundingBoxFromPool(World world, int blockX, int blockY, int blockZ) {
		return AxisAlignedBB.getBoundingBox((double) (blockX + 0), (double) (blockY + 0), (double) (blockZ + 0),
				(double) (blockX + 1), (double) (blockY + 1), (double) (blockZ + 1));
	}
	...
	public IIcon getIcon(int p_149691_1_, int p_149691_2_) {
		return p_149691_1_ == 1 ? (p_149691_2_ > 0 ? this.field_149824_a : this.field_149823_b)
				: ModBlocks.blockBlackSand.getBlockTextureFromSide(p_149691_1_);
	}
	...
	public void updateTick(World p_149674_1_, int p_149674_2_, int p_149674_3_, int p_149674_4_, Random p_149674_5_) {
		if (!this.func_149821_m(p_149674_1_, p_149674_2_, p_149674_3_, p_149674_4_)
			...
			if (l > 0) {
				...
				p_149674_1_.setBlock(p_149674_2_, p_149674_3_, p_149674_4_, ModBlocks.blockBlackSand);
			}
		} else {
	...
	public void onFallenUpon(World p_149746_1_, int p_149746_2_, int p_149746_3_, int p_149746_4_, Entity p_149746_5_,
		...
		if (!p_149746_1_.isRemote && p_149746_1_.rand.nextFloat() < p_149746_6_ - 0.5F) {
			...
			p_149746_1_.setBlock(p_149746_2_, p_149746_3_, p_149746_4_, ModBlocks.blockBlackSand);
		}
	}
	...
	public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_, int p_149695_3_, int p_149695_4_,
		...
		if (material.isSolid()) {
			p_149695_1_.setBlock(p_149695_2_, p_149695_3_, p_149695_4_, ModBlocks.blockBlackSand);
		}
	}

	public Item getItemDropped(int p_149650_1_, Random p_149650_2_, int p_149650_3_) {
		return ModBlocks.blockBlackSand.getItemDropped(0, p_149650_2_, p_149650_3_);
	}
	...
	public Item getItem(World p_149694_1_, int p_149694_2_, int p_149694_3_, int p_149694_4_) {
		return Item.getItemFromBlock(ModBlocks.blockBlackSand);
	}
